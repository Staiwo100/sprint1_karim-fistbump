...
2. Users can purchase powerups using coins to advance gameplay
3. Users can click randomly appearing fistbump icons for a minigame to earn a multiplier
...
## Win & Lose Conditions
You cannot specifically win or lose this game. Instead, it's designed to help you pass the time without the high stress of competitive gaming.

## Controls / Input
This game is played entirely using a mouse/touchpad and space bar for the fistbump multiplier. If you open the snake minigame, you can use the arrow keys to control the green snake. 

## Design Decisions
**Why We Chose a clicker game:** We chose this format of game to allow users to pass the time in a relaxed way while also having some levle of engagement and stimulation. Everyone loves Karim, so we figured this would be a perfect way to assist people in occupying and enjoying their free time.

**Scope Decisions:**
Focused on: Basic functionality and powerups which advanced gameplay and stylized the central image.
...
* Pay attention to visual glitches and issues
* Make sure to try all features
...
* Day 1: Spec design & overall brainstorming
* Day 2-3: Core development & feature implemenation
* Day 4: Last minute additions and bug injections

## Lessons Learned
The most difficult part was coding the entire project with both a team and AI, which we learned how to do by increasing our collaboration and discussions about various features being implemented. Because of our collaboration and organization, we managed to ensure all things went smoothly regardless of roles or any setbacks/challenges.

## Contact
Questions about this game? Ask Jack Daubman or check STANDUP_NOTES.md for context.
